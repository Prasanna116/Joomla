            ...
            .append(
                '<div id="Slide-'+ this.countset+ '" class="tcvnSlideSet-item">' +
                    '<div class="tcvnSlideSet-title">' +
                        ...
                        '<div onclick="TCVNSlideSet.toggle(this)">Slide item ' + this.countset + '</div>' +
                        ...
                        '<div class="tcvnSlideSet-inputs">' +
                            '<div class="tcvnSlideSet-maininfo">' +
                                '<div class="tcvnSlideSet-input">' +
                                    ...
                                    '<input  class="tcvnSlideSet-name" value="Slide-'+ this.countset +'"/>' +
                                '</div>' +
                                '<div class="clr"></div>' +
                                '<div class="tcvnSlideSet-input">' +
                                ...
                                '<div class="tcvnSlideSet-input">' +
                                    ...
                                    '<textarea class="tcvnSlideSet-text" style="width:99%; height:100px">' +
										'<div u="caption" t="*" class="vcs-slide-text" style="top: 10px; left: 10px; width: 480px; height: 300px;"><br/>\n' + 
                                        '<span class="line-1">Lorem ipsum dolor sit amet!</span><br>\n' +
                                        '<span class="line-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br />Cras venenatis placerat nisl.</span><br>\n' +
										'</div>' + 
                                    '</textarea>' +
                                '</div>' +
                                '<div class="clr"></div>' +
