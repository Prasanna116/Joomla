...
class JFormFieldData extends JFormField
{
    ...
    protected function getInput()
    {
		...
		{
            $j30 = 0;
            $doc->addScript(JURI::root().'modules/mod_vina_jssor_content_slider/assets/js/jquery-1.8.3.min.js', 'text/javascript');
            $doc->addScript(JURI::root().'modules/mod_vina_jssor_content_slider/assets/js/chosen.jquery.min.js', 'text/javascript');
            $doc->addStyleSheet(JURI::root().'modules/mod_vina_jssor_content_slider/assets/css/chosen.css', 'text/css');
        }

        $doc->addScript('http://ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_jssor_content_slider/libs/elements/media/slideset.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_jssor_content_slider/libs/elements/media/json2.js', 'text/javascript');

        $doc->addStyleSheet('http://ajax.googleapis.com/ajax/libs/jqueryui/1.9.0/themes/cupertino/jquery-ui.css', 'text/css');
        $doc->addStyleSheet(JURI::root().'modules/mod_vina_jssor_content_slider/libs/elements/media/slideset.css', 'text/css');
        ...
        if($this->value){
            ...
            for($i=0;$i<7;$i++){
                ...
                $default->list[$i]->img = 'modules/mod_vina_jssor_content_slider/samples/s'.($i+1).'.png';
                $default->list[$i]->text = '<div u="caption" t="*" class="vcs-slide-text" style="top: 10px; left: 10px; width: 480px; height: 300px;"><br/><span class="line-1">Free Modules for Joomla! 3</span><br /><span class="line-2">Use our templates with our extensions and create a website today. Simplify your work! </span><br /><br /><a href="http://vinagecko.com/joomla-modules" target="_blank"><img src="modules/mod_vina_jssor_content_slider/samples/find-out-more-bt.png" border="0" width="215" height="50" /></a><br/></div>';
        ...
        <div id="tcvnSlideSet-dir">
            <div class="tcvnSlideSet-item">
                <div class="tcvnSlideSet-input">
                    <label>Path</label>
                    <input id="tcvnSlideSet-path" value="<?php if(isset($slide->dir->path)) echo $slide->dir->path; else echo 'modules/mod_vina_jssor_content_slider/samples/'?>"/>
                </div>
